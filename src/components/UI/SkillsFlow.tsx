...
const iconPaths: Record<string, React.ReactNode> = {
  ...
  framer: <path d="M4 0h16v8h-8zm0 8h8l8 8H4zm0 8h8v8z" fill="currentColor" />,
  css: (
    <path
...
export function SkillsFlow({ className }: { className?: string }) {
  ...
  return (
    <div className={cn("relative overflow-hidden w-full", className)}>
      ...
      {tooltip.visible && (
        <motion.div
          className="fixed z-50 px-3 py-1 text-sm font-medium text-white rounded-md pointer-events-none bg-black/80 backdrop-blur-md"
